...
The project is developed in **Python** and utilizes search algorithms such as **A\*** to navigate characters within the game environment.
...
```bash
git clone https://github.com/NamCow/Hide-Seek.git
```
